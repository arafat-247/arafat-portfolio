...
This release implements the approved Tamires-inspired design, a GitHub-backed publishing studio, separately organised Reporting, Opinion & Analysis and Thoughts, uploaded photography, durable Daily Star article storage, scheduled refresh and reviewed manual URL imports.
...
- `content/overrides.json`: reviewed publication state, dates and categories.
...
- `site/assets/`: user photographs, identity imagery and downloaded covers.
