...
class BuildTests(unittest.TestCase):
    ...
    def test_drafts_and_attribution(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('class="mobilelive"',home)
            self.assertIn('class="mobilelive-profile"',home)
            self.assertIn('class="mobilelive-work"',home)
            self.assertIn('class="mobilelive-card mobilelive-reporting"',home)
            self.assertIn('class="mobilelive-card mobilelive-opinion"',home)
            self.assertIn('class="mobilelive-card mobilelive-thoughts"',home)
            self.assertIn('class="mobilelive-card mobilelive-photography"',home)
            self.assertIn('class="mobilelive-menu"',home)
