...
class BuildTests(unittest.TestCase):
    ...
    def test_drafts_and_attribution(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('class="homecontent"',home)
            self.assertIn('class="editorialhero"',home)
            self.assertIn('class="workintro"',home)
            self.assertIn('class="workgrid"',home)
            self.assertIn('class="worktile worktile-reporting"',home)
            self.assertIn('class="worktile worktile-opinion"',home)
            self.assertIn('class="worktile worktile-thoughts"',home)
            self.assertIn('class="worktile worktile-photos"',home)
            self.assertEqual(home.count('class="worktile-number"'),4)
            self.assertEqual(home.count('class="worktile-arrow"'),4)
            self.assertIn('Stories for a more thoughtful Bangladesh.',home)
            ...
            self.assertRegex(home,r'class="worktile worktile-photos"[^>]*>.*?<img ',msg='Photography work tile should contain an image')
