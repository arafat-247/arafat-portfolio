...
class BuildTests(unittest.TestCase):
    ...
    def test_drafts_and_attribution(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('assets/home/approved-desk-mobile.webp',home)
            self.assertIn('class="desksemantics"',home)
            self.assertIn('class="deskhotspots deskhotspots-desktop"',home)
            self.assertIn('class="deskhotspots deskhotspots-mobile"',home)
            ...
            self.assertIn('class="deskmobilemenu"',home)
            ...
            self.assertTrue((out/'assets/home/approved-desk-mobile.webp').is_file())
