...
class BuildTests(unittest.TestCase):
    ...
    def test_drafts_and_attribution(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('class="portalhome"',home)
            self.assertIn('class="portalnav"',home)
            self.assertIn('class="portalhero"',home)
            self.assertIn('class="portalwork"',home)
            ...
            self.assertEqual(home.count('class="portalnumber"'),4)
            self.assertEqual(home.count('class="portalarrow"'),4)
            self.assertIn('assets/home/reference-report.webp',home)
            self.assertIn('assets/home/reference-photo.webp',home)
            self.assertNotIn('Stories from a changing Bangladesh',home)
            ...
            self.assertNotIn('class="tile tile-reporting"',home)
            self.assertRegex(home,r'class="portalpanel portal-photography"[^>]*>.*?<img ',msg='Photography portal should contain an image')
