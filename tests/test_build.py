...
class BuildTests(unittest.TestCase):
    ...
    def test_drafts_and_attribution(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertNotIn('assets/home/approved-desk-mobile.webp',home)
            self.assertIn('class="desksemantics"',home)
            self.assertIn('class="deskhotspots deskhotspots-desktop"',home)
            self.assertNotIn('class="deskhotspots deskhotspots-mobile"',home)
            ...
            self.assertIn('class="mobilefresh"',home)
            self.assertIn('class="mf-photo"',home)
            self.assertIn('class="mf-work"',home)
            self.assertIn('class="mf-card mf-reporting"',home)
            self.assertIn('class="mf-card mf-opinion"',home)
            self.assertIn('class="mf-card mf-thoughts"',home)
            self.assertIn('class="mf-card mf-photography"',home)
            self.assertNotIn('class="mf-menu"',home)
            self.assertIn('class="mf-quicknav"',home)
            self.assertIn('href="about/"',home)
            self.assertIn('About me',home)
            self.assertIn('class="mf-email-link"',home)
