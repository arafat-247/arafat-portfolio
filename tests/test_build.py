...
class BuildTests(unittest.TestCase):
    ...
    def test_drafts_and_attribution(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            clean_story=next((p for p in story_pages if 'class="articlehead"' in p.read_text()),None)
            self.assertIsNotNone(clean_story)
            story_html=clean_story.read_text()
            self.assertIn('class="page reading articlepage"',story_html)
            self.assertIn('class="articlehead"',story_html)
            self.assertIn('class="articlemeta"',story_html)
            self.assertIn('class="articlebodywrap"',story_html)
