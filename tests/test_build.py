...
class BuildTests(unittest.TestCase):
    ...
    def test_drafts_and_attribution(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('class="journeyhome"',home)
            self.assertIn('class="journeyhead"',home)
            self.assertIn('class="journeycanvas"',home)
            self.assertIn('class="journeyhero"',home)
            self.assertIn('class="journeymap"',home)
            self.assertIn('class="journeynode journey-reporting"',home)
            self.assertIn('class="journeynode journey-opinion"',home)
            self.assertIn('class="journeynode journey-thoughts"',home)
            self.assertIn('class="journeynode journey-photography"',home)
            self.assertEqual(home.count('class="journeymarker"'),4)
            self.assertEqual(home.count('class="journeynumber"'),4)
            self.assertIn('Four paths through a changing Bangladesh',home)
            ...
            self.assertRegex(home,r'class="journeynode journey-photography"[^>]*>.*?<img class="journeyphoto"',msg='Photography destination should contain an image')
