...
class BuildTests(unittest.TestCase):
    ...
    def test_drafts_and_attribution(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn('class="deskhome"',home)
            self.assertIn('class="deskstage"',home)
            self.assertIn('class="deskprofile"',home)
            self.assertIn('assets/portraits/byline.avif',home)
            self.assertIn('class="deskpiece desk-reporting"',home)
            self.assertIn('class="deskpiece desk-opinion"',home)
            self.assertIn('class="deskpiece desk-thoughts"',home)
            self.assertIn('class="deskpiece desk-photography"',home)
            self.assertEqual(home.count('class="desklabel"'),4)
            ...
            self.assertRegex(home,r'class="deskpiece desk-photography"[^>]*>.*?<img ',msg='Photography desk piece should contain an image')
