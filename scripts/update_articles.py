...
UA="Mozilla/5.0 (compatible; ArafatRahamanPortfolio/10.0; public-author-portfolio-indexer)"
...
def art_svg(story):
    ...
    'transport':'<g transform="translate(610 145)"><rect x="40" y="20" width="390" height="240" rx="55"/><rect x="86" y="60" width="95" height="82" fill="#f1efe9"/><rect x="205" y="60" width="95" height="82" fill="#f1efe9"/><rect x="324" y="60" width="62" height="82" fill="#f1efe9"/><circle cx="135" cy="222" r="18" fill="#f1efe9"/><circle cx="337" cy="222" r="18" fill="#f1efe9"/><path d="M0 292H470M55 320H415" stroke="currentColor" stroke-width="8"/></g>',
    'politics':'<g transform="translate(650 125)"><path d="M0 110 L180 10 360 110Z"/><rect x="35" y="120" width="42" height="210"/><rect x="110" y="120" width="42" height="210"/><rect x="185" y="120" width="42" height="210"/><rect x="260" y="120" width="42" height="210"/><rect x="0" y="330" width="360" height="28"/><rect x="390" y="185" width="160" height="120" rx="8" opacity=".55"/><path d="M430 120h80l-18 84h-45z" fill="#f1efe9"/></g>',
    'education':'<g transform="translate(620 155)"><path d="M0 80 Q125 20 250 80v230Q125 250 0 310z"/><path d="M500 80 Q375 20 250 80v230Q375 250 500 310z" opacity=".7"/><path d="M250 80v230" stroke="#f1efe9" stroke-width="7"/><path d="M60 135h120M60 180h135M320 135h120M305 180h135" stroke="#f1efe9" stroke-width="7"/></g>',
    'justice':'<g transform="translate(655 120)"><path d="M190 10v330M70 80h240" stroke="currentColor" stroke-width="14"/><path d="M65 80l-55 120h110zM315 80l-55 120h110z" fill="none" stroke="currentColor" stroke-width="10"/><rect x="390" y="50" width="180" height="270" rx="8" opacity=".52"/><path d="M425 105h110M425 150h80M425 210h120M425 255h95" stroke="#f1efe9" stroke-width="12"/></g>',
    ...
    'sport':'<g transform="translate(650 120)"><rect x="0" y="30" width="520" height="320" rx="8" fill="none" stroke="currentColor" stroke-width="10"/><circle cx="260" cy="190" r="78" fill="none" stroke="currentColor" stroke-width="10"/><path d="M260 30v320" stroke="currentColor" stroke-width="10"/><circle cx="420" cy="245" r="58"/><path d="M390 225l30-25 35 20-8 42-40 12-25-28z" fill="#f1efe9"/></g>',
    'reporting':'<g transform="translate(650 125)"><rect x="0" y="0" width="330" height="360" rx="8"/><path d="M45 70h240M45 125h200M45 205h240M45 260h170" stroke="#f1efe9" stroke-width="12"/><circle cx="450" cy="160" r="90" opacity=".65"/><path d="M450 250v130M400 380h100" stroke="currentColor" stroke-width="16"/></g>'}
    drawing=drawings[kind]
    return f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 675" role="img" aria-labelledby="t d"><title id="t">Editorial illustration for {html_lib.escape(story.get('title','Story'))}</title><desc id="d">Original portfolio illustration based on the subject of the article.</desc><rect width="1200" height="675" fill="#e8e5de"/><rect x="0" width="16" height="675" fill="#355f58"/><g fill="#171715" color="#355f58">{drawing}</g><text x="70" y="105" font-family="Arial, sans-serif" font-size="20" font-weight="700" letter-spacing="5" fill="#355f58">{topic.upper()}</text><text x="70" y="525" font-family="Georgia, serif" font-size="48" fill="#171715">{concept}</text><path d="M70 560H505" stroke="#171715" stroke-width="2"/><text x="70" y="602" font-family="Arial, sans-serif" font-size="15" letter-spacing="3" fill="#68706c">ORIGINAL EDITORIAL ILLUSTRATION</text></svg>'''
...
def story_header():
    return '''<header class="site-header"><div class="site-shell header-inner"><a class="brand" href="../../" aria-label="Arafat Rahaman home"><strong>Arafat Rahaman</strong><span>Journalist · Photographer</span></a><nav class="desktop-nav" aria-label="Primary navigation"><a href="../../archive.html">Work</a><a href="../../journal.html">Journal</a><a aria-current="page" href="../../published-work.html">Published Work</a><a href="../../photography.html">Photography</a><a href="../../about.html">About</a></nav><a class="tip-button desktop-tip" href="../../contact.html#send-a-tip">Send a news tip</a><button class="menu-toggle" type="button" data-menu-toggle aria-controls="mobile-menu" aria-expanded="false">Menu</button></div></header><div id="mobile-menu" class="mobile-menu" data-mobile-nav hidden><div class="mobile-menu-head site-shell"><a class="brand brand-inverse" href="../../"><strong>Arafat Rahaman</strong><span>Journalist · Photographer</span></a><button type="button" data-menu-close>Close</button></div><nav class="mobile-menu-links site-shell" aria-label="Mobile navigation"><a href="../../archive.html">Work</a><a href="../../journal.html">Journal</a><a href="../../published-work.html">Published Work</a><a href="../../photography.html">Photography</a><a href="../../about.html">About</a><a href="../../contact.html">Contact</a></nav><div class="mobile-menu-foot site-shell"><a href="../../contact.html#send-a-tip">Send a news tip →</a></div></div>'''
def story_footer():
    return '''<footer class="site-footer"><div class="site-shell footer-grid"><div class="footer-brand"><strong>Arafat Rahaman</strong><span>Journalist · Photographer · Dhaka</span></div><nav><a href="../../archive.html">Work</a><a href="../../journal.html">Journal</a><a href="../../published-work.html">Published Work</a><a href="../../photography.html">Photography</a><a href="../../about.html">About</a></nav><div class="footer-contact"><a href="mailto:arafat.mcj@yahoo.com">arafat.mcj@yahoo.com</a><div><a href="https://www.instagram.com/araafat.rahaman/" target="_blank" rel="me noopener">Instagram</a><a href="https://www.flickr.com/photos/arafat-rahaman/" target="_blank" rel="me noopener">Flickr</a><a href="../../feed.xml">RSS</a></div></div></div><div class="site-shell footer-bottom"><span>© Arafat Rahaman</span><a href="../../contact.html#send-a-tip">Send a news tip →</a></div></footer>'''
def generate_story_page(story,config,enhancements):
    source=story["url"]
    title=html_lib.escape(story["title"])
    excerpt=html_lib.escape(story.get("excerpt","") or "")
    typ=html_lib.escape(story["story_type"])
    topic=html_lib.escape(story.get("topic") or "")
    pub=display_date(story.get("date_published",""))
    mod=display_date(story.get("date_modified",""))
    body=story.get("body_html","") or '<p>The article body could not be extracted cleanly. Please read the original publication.</p>'
    local_abs=abs_site(config,story["local_url"])
    category_q=quote(story["story_type"])
    topic_q=quote(story.get("topic") or "")
    e=enhancements.get(source,{}) if isinstance(enhancements.get(source,{}),dict) else {}
    hero=e.get("hero",{}) if isinstance(e,dict) else {}
    if isinstance(hero,dict) and hero.get("base"):
        hero_html=f'<figure class="story-hero">{picture_markup(hero["base"],hero.get("alt") or f"Story image for {story["title"]}")}<figcaption><span>{html_lib.escape(hero.get("caption","") or "")}</span><span>{html_lib.escape(hero.get("credit","") or "")}</span></figcaption></figure>'
        og_image=abs_site(config,hero["base"]+".webp")
    else:
        hero_html=""; og_image=""
    raw_pub=story.get("date_published",""); raw_mod=story.get("date_modified","")
    updated="" if not raw_mod or published_sort(raw_mod)<=published_sort(raw_pub)+60 else f'<span>Updated {html_lib.escape(mod)}</span>'
    author_names_clean=story.get("authors") or [AUTHOR_NAME]
    byline=html_lib.escape(" and ".join(author_names_clean))
    author_json=[{"@type":"Person","name":n} for n in author_names_clean]
    ...
    topic_meta=f'<a href="../../archive.html?topic={topic_q}">{topic}</a>' if topic and topic!="Public Affairs" else ""
    stand=f'<p class="story-standfirst">{excerpt}</p>' if excerpt else ""
    readmins=max(1,round(story.get('word_count',0)/220))
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#f7f6f2"><meta name="robots" content="noindex,follow"><title>{title} — Arafat Rahaman</title><meta name="description" content="{excerpt}"><link rel="canonical" href="{html_lib.escape(source,quote=True)}"><link rel="icon" href="../../assets/favicon.svg" type="image/svg+xml"><link rel="alternate" type="application/rss+xml" href="../../feed.xml"><meta property="og:type" content="article"><meta property="og:title" content="{title}"><meta property="og:description" content="{excerpt}"><meta property="og:url" content="{html_lib.escape(local_abs,quote=True)}">{f'<meta property="og:image" content="{html_lib.escape(og_image,quote=True)}">' if og_image else ''}<script type="application/ld+json">{jsonld_text}</script><link rel="stylesheet" href="../../styles.css?v=13"></head><body class="story-page" data-root="../../" data-source-url="{html_lib.escape(source,quote=True)}" data-word-count="{story.get('word_count',0)}"><div id="reading-progress" class="reading-progress" hidden><span></span></div><a class="skip-link" href="#article">Skip to article</a>{story_header()}<main class="story-main site-shell"><nav class="story-breadcrumb" aria-label="Breadcrumb"><a href="../../published-work.html">Published Work</a> / <a href="../../archive.html?type={category_q}">{typ}</a></nav><header class="story-opening"><div class="story-head-meta"><span class="provenance">Published Work · The Daily Star</span><a href="../../archive.html?type={category_q}">{typ}</a>{topic_meta}<span>Published {html_lib.escape(pub)}</span>{updated}</div><h1>{title}</h1>{stand}<div class="byline-strip"><img src="../../assets/portraits/byline.webp" alt="Arafat Rahaman" width="58" height="58"><div><strong>By {byline}</strong><span>{readmins} min read</span></div></div></header>{hero_html}<div class="story-reading"><div class="story-body-grid"><aside class="share-column" aria-label="Share this story"><div class="share-rail"><p>Share</p><button data-share="copy" title="Copy link">Link</button><button data-share="whatsapp" title="Share on WhatsApp">WA</button><button data-share="facebook" title="Share on Facebook">f</button><button data-share="x" title="Share on X">X</button><button data-share="linkedin" title="Share on LinkedIn">in</button><button data-print title="Print or save PDF">PDF</button></div></aside><article id="article" class="story-prose">{body}</article></div></div><div class="mobile-share-bar" aria-label="Share this story" hidden><button data-share="copy">Copy</button><button data-share="whatsapp">WhatsApp</button><button data-share="facebook">Facebook</button><button data-print>Print</button></div><section id="story-documents" class="story-documents" hidden><p class="eyebrow">Documents &amp; context</p><h2>Source material</h2><div class="document-links"></div></section><section class="source-note"><div><span>Original publication</span><strong>The Daily Star · {html_lib.escape(pub)}</strong></div><a href="{html_lib.escape(source,quote=True)}" target="_blank" rel="noopener">View original article ↗</a></section><section id="related-stories" class="related-section"></section></main>{story_footer()}<script src="../../common.js?v=13"></script><script src="../../story.js?v=13"></script></body></html>'''
...
def write_feed(stories,config):
    journal_file=SITE/"data"/"journal-index.json"
    journal=[]
    if journal_file.exists():
        try:
            journal=[a for a in json.loads(journal_file.read_text(encoding="utf-8")).get("articles",[]) if a.get("status")!="draft" and a.get("local_url")]
        except Exception:journal=[]
    entries=[]
    for s in stories:
        entries.append({"title":s.get("title",""),"link":abs_site(config,s.get("local_url","")),"guid":s.get("url",""),"description":s.get("excerpt",""),"date":s.get("date_published","")})
    for s in journal:
        entries.append({"title":s.get("title",""),"link":abs_site(config,s.get("local_url","")),"guid":f"journal:{s.get('slug','')}","description":s.get("deck",""),"date":s.get("date_published") or s.get("date","")})
    entries.sort(key=lambda x:published_sort(normalise_datetime(x.get("date",""))),reverse=True)
    items=[]
    for s in entries[:50]:
        link=s["link"];pub=s.get("date","")
        try:rfc=datetime.fromisoformat(pub.replace("Z","+00:00")).strftime("%a, %d %b %Y %H:%M:%S %z")
        except Exception:rfc=""
        items.append(f'<item><title>{xml_escape(s["title"])}</title><link>{xml_escape(link)}</link><guid isPermaLink="false">{xml_escape(s["guid"])}</guid><description>{xml_escape(s.get("description",""))}</description>{f"<pubDate>{rfc}</pubDate>" if rfc else ""}</item>')
...
def write_sitemap(config):
    urls=["","archive.html","journal.html","published-work.html","photography.html","about.html","contact.html"]
    journal_file=SITE/"data"/"journal-index.json"
    if journal_file.exists():
        try:
            urls.extend(a["local_url"] for a in json.loads(journal_file.read_text(encoding="utf-8")).get("articles",[]) if a.get("status")!="draft" and a.get("local_url"))
        except Exception:pass
...
def write_art_queue(stories,enhancements):
    ...
    for s in stories:
        ...
        if not isinstance(e,dict) or not e.get("hero"):
            q.append({"url":s["url"],"local_url":s["local_url"],"title":s["title"],"excerpt":s.get("excerpt",""),"topic":s.get("topic"),"story_type":s.get("story_type"),"art_direction":"Optional: create an original editorial illustration only when a visual genuinely adds reporting or explanatory value. It must communicate the specific subject or central argument. Avoid generic newsroom branding, text-heavy covers and decorative AR monograms."})
...
def main():
    ...
    index_fields=("title","excerpt","url","authors","story_type","topic","format_tag","date_published","date_modified","date","published_sort","word_count","data_rich","verified_author","local_url")
