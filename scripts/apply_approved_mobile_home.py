...
/* Hard-lock the four approved portfolio backgrounds in the final mobile pass. */
.portal-reporting{background-color:#ece5da!important;background-image:url("assets/home/reference-report.webp")!important;background-repeat:no-repeat!important;background-size:cover!important;background-position:center!important}
.portal-opinion{background-color:#8c170e!important;background-image:url("assets/home/portal-reference-sprite.webp")!important;background-repeat:no-repeat!important;background-size:100% 300%!important;background-position:center 50%!important}
.portal-thoughts{background-color:#f2ece2!important;background-image:url("assets/home/portal-reference-sprite.webp")!important;background-repeat:no-repeat!important;background-size:100% 300%!important;background-position:center bottom!important}
.portal-photography{background-color:#07100f!important;background-image:url("assets/home/reference-photo.webp")!important;background-repeat:no-repeat!important;background-size:cover!important;background-position:center!important}
...
def main():
    ...
    print('Approved mobile homepage applied: header_option=1, selected_reporting=3, duplicate_label=removed, divider=readable, portfolio_backgrounds=hard_locked, desktop_untouched=1')
