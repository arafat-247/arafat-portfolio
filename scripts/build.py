...
class Builder:
    ...
    def page(self,path,title,body,home=False,desc='',article_data=None,profile=False,social_image_path=''):
        ...
        home_nav=(('01','index.html','Portfolio'),('02','about.html','About me'),('03','contact.html','Contact'))
        def nav_markup(items):
            return ''.join(f'<a href="{prefix}{href}"><span>{number}</span>{label}</a>' for number,href,label in items)
