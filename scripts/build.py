...
def build():
    ...
    hero=(
        ...
        '<div class="portalhero-copy"><span class="portalkicker">Journalist · Dhaka</span>'
        '<h1 id="portal-home-title">Arafat <em>Rahaman</em></h1>'
        ...
        '<p class="portalhero-script">Stories for a more thoughtful Bangladesh.</p>'
